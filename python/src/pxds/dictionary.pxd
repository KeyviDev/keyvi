...
cdef extern from "keyvi/dictionary/dictionary.h" namespace "keyvi::dictionary":
    ...
    cdef cppclass Dictionary:
        ...
        _MatchIteratorPair Get (libcpp_utf8_string) # wrap-as:get_values
        ...
        _MatchIteratorPair GetFuzzy (libcpp_utf8_string, int32_t max_edit_distance) except + # wrap-as:get_fuzzy
        ...
        _MatchIteratorPair Lookup(libcpp_utf8_string) # wrap-as:lookup
        _MatchIteratorPair LookupText(libcpp_utf8_string) # wrap-as:lookup_text
        libcpp_utf8_output_string GetManifest() except + # wrap-as:get_manifest
