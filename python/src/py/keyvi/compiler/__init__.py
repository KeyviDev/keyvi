...
from keyvi._core import (
    ...
    SecondaryKeyFloatVectorDictionaryCompiler,
    SecondaryKeyIntDictionaryCompiler,
)
from keyvi._core import (
    SecondaryKeyKeyOnlyDictionaryCompiler,
    SecondaryKeyStringDictionaryCompiler,
...
def JsonDictionaryCompilerSmallData(*args, **kwargs):
    ...
    warn(
        "JsonDictionaryCompilerSmallData is deprecated and will be removed in a future version. Use JsonDictionaryCompiler instead."
    )
...
def IntDictionaryCompilerSmallData(*args, **kwargs):
    ...
    warn(
        "IntDictionaryCompilerSmallData is deprecated and will be removed in a future version. Use IntDictionaryCompiler instead."
    )
