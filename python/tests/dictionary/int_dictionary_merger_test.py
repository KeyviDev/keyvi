...
key_values_1 = {"a": 12, "bzzzz": 34, "bbb": 34, "b": 34}

key_values_2 = {"a": 78, "c": 5, "i": 5, "ia": 5, "d": 6}

key_values_3 = {"e": 76, "d": 356, "e1": 76, "e2": 76, "e3": 76, "e4": 76, "f": 9}
...
@pytest.mark.parametrize(
    "merger",
    [
        IntDictionaryMerger({"memory_limit_mb": "10"}),
...
def test_merge(merger):
    ...
    try:
        ...
        for (base_key, base_value), (keyvi_key, keyvi_value) in zip(
            key_values_ordered.items(), merged_dictionary.items()
        ):
