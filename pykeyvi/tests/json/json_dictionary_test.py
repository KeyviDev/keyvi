...
def test_simple_zlib():
    c = pykeyvi.JsonDictionaryCompiler({"memory_limit_mb":"10", 'compression': 'z', 'compression_threshold': '0'})
    c.Add("abc", '{"a" : 2}')
    c.Add("abd", '{"a" : 3}')
...
def test_simple_snappy():
    c = pykeyvi.JsonDictionaryCompiler({"memory_limit_mb":"10", 'compression': 'snappy', 'compression_threshold': '0'})
    c.Add("abc", '{"a" : 2}')
    c.Add("abd", '{"a" : 3}')
...
def test_float_compaction():
    cs = pykeyvi.JsonDictionaryCompiler({"memory_limit_mb":"10", 'floating_point_precision': 'single'})
    cd = pykeyvi.JsonDictionaryCompiler({"memory_limit_mb":"10"})
