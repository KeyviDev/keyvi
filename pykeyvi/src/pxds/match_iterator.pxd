...
cdef extern from "dictionary/match_iterator.h" namespace "keyvi::dictionary":
...
cdef extern from "dictionary/match_iterator.h" namespace "keyvi::dictionary::MatchIterator":
